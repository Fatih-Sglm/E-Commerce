    ...
    public partial class InitializeDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonelRole", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PersonelRole_Personels_PersonelId",
                        column: x => x.PersonelId,
                        principalTable: "Personels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PersonelRole_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAppoIsApproved = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Comments_VendorProducts_VendorProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_VendorProductId",
                table: "Comments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonelRole_PersonelId",
                table: "PersonelRole",
                column: "PersonelId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonelRole_RoleId",
                table: "PersonelRole",
                column: "RoleId");
